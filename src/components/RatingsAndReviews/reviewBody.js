...
export default function ReviewBody(props) {
  ...
  if (props.text.length > 250) {
        ...
        {showAll ? (
          <div>
            ...
            <Grid container>
              <Grid item xs={4} />
              <Grid item xs={4}>
                <button className="reviewBodyButton" onClick={handleShowLess}>
                  Show Less
                </button>
              </Grid>
              <Grid item xs={4} />
          ...
          <div>
            ...
            <Grid container>
              <Grid item xs={4} />
              <Grid item xs={4}>
                <button className="reviewBodyButton" onClick={handleShowMore}>
                  Show More
                </button>
              </Grid>
              <Grid item xs={4} />
    ...
    return <p className="reviewBody">{props.text}</p>;
  }
}
